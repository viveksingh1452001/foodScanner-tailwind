  ...
  return (
    ...
    >
      <div className="px-6 py-2 backdrop-blur-xl bg-black/80 rounded-lg font-bold w-full h-full">
        <div className={`group-hover:scale-100 flex ${isHovered ? 'text-yellow-500' : 'text-yellow-600'} gap-1`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth="1.8"
            className={`w-6 h-6 stroke-yellow-600 ${isHovered ? 'stroke-yellow-500' : ''}`}
          >
            <path
              strokeLinecap="round"
